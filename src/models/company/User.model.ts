...
//match password
CompanyUserSchema.methods.isPasswordMatched = async function (enteredPassword: string) {
  return await bcrypt.compare(enteredPassword, this.password);
};

const CompanyUserModel = mongoose.model<CompanyUserDocument>('company_user', CompanyUserSchema);
